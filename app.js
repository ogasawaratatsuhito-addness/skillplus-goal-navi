...
const RESULTS = {
  ...
  action: {
    ...
    service: "Addness・メイン作業場（必要に応じてサクセスラーニング）", serviceNote: "Addnessを正本に、AIエージェントと実行します。知識や手順が必要なときはサクセスラーニングのアクションマップを使います。",
  ...
  stuck: {
    ...
    service: "Addness・AIエージェント（必要に応じてサクセスラーニング）", serviceNote: "ゴールの文脈を保ったままAIと整理し、学習内容はスキルプラスくんや講師質問も使います。",
